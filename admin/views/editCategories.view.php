        ...
        <?php endif;?> -->
         ...
         <div class="mb-4">
            ...
            <div class="mb-3">
                ...
                <input type="hidden" class="form-control" name="orgimg" value="<?=$category->category_image?>">
            </div>
            <div>
            <img src="../../images/<?=$category->category_image?>" alt="" style="width:150px;height:150px">
            </div>
           
            <input type="hidden" name="modified_at" value="<?php echo date('Y-m-d')?>">
