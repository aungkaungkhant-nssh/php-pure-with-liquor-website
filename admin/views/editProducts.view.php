...
<body class="bg-info">
    <div class="container w-50 mt-5">
        ...
        <?php endif;?> -->
         ...
         <form action="/admin/updateproducts" method="post" enctype="multipart/form-data">
         <div class="mb-4">
            ...
            <div class="mb-3">
                ...
                <input type="hidden" class="form-control" name="orgimg" value="<?=$product->image?>">
            </div>
            <div class="mb-3">
            ...
            <div>
            <img src="../../images/<?=$product->image?>" alt="" style="width:150px;height:150px">
            </div>
           
            <input type="hidden" name="updated_at" value="<?php echo date('Y-m-d')?>">
            <a href="/admin/products" class="btn btn-warning text-center  my-3" >Back</a>
